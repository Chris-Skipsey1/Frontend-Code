...
export const API = {};
API.get = (endpoint) => callFetch(endpoint, 'GET', null); //GET
API.post = (endpoint, data) => callFetch(endpoint, 'POST', data); //POST
API.put = (endpoint, data) => callFetch(endpoint, 'PUT', data); //PUT
API.delete = (endpoint) => callFetch(endpoint, 'DELETE', null); //DELETE 
